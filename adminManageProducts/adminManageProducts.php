...
<head>
    ...
    <link rel="stylesheet" href="../style/adminMangeProducts.css">
                            ...
                            <div class="col-12 text-center py-3">
                                <div class="row">
                                    <div class="col-lg-4 offset-lg-4 col-12">
                                        <h1 class="divHeaderText text-center">Admin Manage Products</h1>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-12 offset-0 py-1">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-12 py-2 my-auto">
                                                                        <span>Qty</span>
                                                                    ...
                                                                    <div class="col-lg-12 col-12 pt-3 px-4">
                                                                        <div class="row">
                                                                            <div class="col-lg-12 offset-lg-0 col-md-10 offset-md-1 col-12 text-center py-1 px-md-2 px-3 px-lg-0">
                                                                                <button class="buyButton w-100 py-1">Block Product</button>
                                                                            </div>
                                                                            <div class="col-lg-12 offset-lg-0 col-md-10 offset-md-1 col-12 text-center py-1 px-md-2 px-3 px-lg-0">
