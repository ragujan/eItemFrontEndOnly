                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12 imageSliderDivHolder">
                                        <div class="row">
                                            ...
                                            <div class="col-12 imageSliderDiv d-none">
                                                <div class="row">
                                                    <div class="col-12    ">
                                                        <div class="row">
                                                            <div class="  col-12">
                                                                <div class="row">
                                                                    <div class="col-4 text-center px-2 sliderImages">
                                                            ...
                                                            <!-- <div class="sliderImages hideTransistion col-12 d-none">
                                                                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="row">
                                                ...
                                                <div class="row coldHotProductsListRow py-4 ">
                                                    <div class="col-12 coldHotSliderItemsDiv ">
                                                        <div class="coldHotSliderItemsImagesDiv">
                                                            <div class="coldHotSliderItemsImages col-12">
                                                                <div class="row">
                                                                    <div class="col-4 text-center"> <img class="coldHotDealsImage " src="../images/Deals.png" alt="" srcset=""></div>
                                                                    <div class="col-4 text-center"> <img class="coldHotDealsImage " src="../images/Deals.png" alt="" srcset=""></div>
                                                                    <div class="col-4 text-center"> <img class="coldHotDealsImage " src="../images/Deals.png" alt="" srcset=""></div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="coldHotarrowIconsDiv  col-4 text-center">
                            ...
                            <div class="col-12 popHotsliderContainerHolder">
                                <div class="popHotsliderImageContainerHolder pt-2 pb-3">
                                    <div class="popHotSliderImageContainer">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals.png" alt="">
                                        <img class="popHotSliderImage col-3 col-md-6" src="../images/Deals3.png" alt="">
                                    </div>
                                </div>
