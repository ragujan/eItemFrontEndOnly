...
const miniProductImages = dgebCName("miniproductImage");
const productImage = dgebCName('productImage')[0];
let miniProductImageShow = () => {
  for (let i = 0; i < miniProductImages.length; i++) {
    miniProductImages[i].addEventListener("click", () => {
       let src = miniProductImages[i].getAttribute('src');
        productImage.src =src;
    });
  }
};
miniProductImageShow();
